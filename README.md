...
(This repo is forked from `ZhouL-lab/PLHN` to offer a detailed guide. There are slight modifications of dataloader to fit the given dataset.)

```bash
# Clone this repo:
git clone https://github.com/Fluorite8/PLHN.git
cd PLHN

# Create & activate conda env
conda create -n plhn python==3.8
conda activate plhn
...
```bash
# Split the dataset
cd ./data/YNpre/data_folder/
mv test5.txt all_data.txt
head -n 20 all_data.txt > test5.txt
tail -n +21 all_data.txt > train5.txt
